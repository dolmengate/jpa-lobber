...
/**
 * XmlpRptI8Id generated by hbm2java
 */
@Embeddable
public class XmlpRptI8Id  implements java.io.Serializable {
    ...
    public XmlpRptI8Id(BigDecimal idRptXmlp, String lcl) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof XmlpRptI8Id) ) return false;
		 XmlpRptI8Id castOther = ( XmlpRptI8Id ) other; 
         
		 return ( (this.getIdRptXmlp()==castOther.getIdRptXmlp()) || ( this.getIdRptXmlp()!=null && castOther.getIdRptXmlp()!=null && this.getIdRptXmlp().equals(castOther.getIdRptXmlp()) ) )
